...
const ConnectionForm = ({ mode }: ConnectionFormProps) => {
  ...
  const fetchConnection = async (connectionId: number) => {
    try {
      ...
      // Use credential data from connection response (no need for separate API call)
      ...
      if (credential) {
        ...
        // Fallback if credential data is missing
        console.warn('No credential data in connection response')
